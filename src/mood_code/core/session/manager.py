...
from mood_code.core.bus.envelope import HandlerError
...
from mood_code.core.session.model import Session, SessionMode
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from mood_code.core.bus.commands import SessionCompactResult
